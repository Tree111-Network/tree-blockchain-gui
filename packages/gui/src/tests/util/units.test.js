...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of tree', () => {
      const result = units.getUnit('tree');
    ...
    it('gets unit of tree using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of tree', () => {
      const result = units.getDisplay('tree');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('tree', 9);

      const result = units.getUnit('tree');

      expect(result).toEqual(9);

      units.setUnit('tree', 1);
    });
  });
  describe('#setDisplay', () => {
    ...
    it('updates an existing display', () => {
      units.setDisplay('tree', {
        format: '{amount} TTREE111',
        fractionDigits: 0,
      });
