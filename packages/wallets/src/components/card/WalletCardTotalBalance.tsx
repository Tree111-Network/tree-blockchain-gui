import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@tree/api-react';
import { CardSimple, Flex, TooltipIcon } from '@tree/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for TREE111, CATs, or
